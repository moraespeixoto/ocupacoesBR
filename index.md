...
<img src="logo.png" alt="Do código bruto de ocupação às ocupações classificadas" />
</div>
</div>
</div>
...
<a href="reference/figures/rede_crosswalks.png" title="Abrir o mapa em tamanho cheio"><img src="reference/figures/rede_crosswalks.png" alt="As traduções que o pacote faz, e as que não faz" /></a>
</div>
</div>
