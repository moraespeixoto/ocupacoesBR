...
reguas <- data.frame(
  ...
  quando_nao_usar = c(
    ...
    paste("não publique onze classes a partir do TSE: sem número de subordinados, IVa e IVb não se separam;",
          "colapse em 5 ou 3 para publicar; pela RAIS e pelo eSocial, que só registram empregados,",
          "IVa, IVb e V saem vazias por construção; a PNAD separa IVa de IVb, mas nem ela tem a supervisão que define V"),
