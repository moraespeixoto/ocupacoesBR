...
O autor deste pacote foi aluno de Valle Silva, trabalhou com Costa
Ribeiro e foi colega de turma de Carvalhaes. O que se lê aqui não é uma
alternativa a essa linhagem: é um instrumento construído dentro dela,
para uma fonte de dados que ela ainda não tinha alcançado.
